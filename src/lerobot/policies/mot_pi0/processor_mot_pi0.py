...
This module provides pre-processing and post-processing pipelines for the MoT-PI0 policy.
It follows the same pattern as processor_pi0.py for PI0-style flow matching models.
"""
...
@ProcessorStepRegistry.register(name="mot_pi0_new_line_processor")
class MoTPI0NewLineProcessor(ComplementaryDataProcessorStep):
    """
...
def make_mot_pi0_pre_post_processors(
    config: MoTPI0Config,
    ...
    """
    Constructs pre-processor and post-processor pipelines for the MoT-PI0 policy.
    ...
    Args:
        config: The configuration object for the MoT-PI0 policy.
    ...
    # Build input processing steps - same pattern as PI0
    input_steps: list[ProcessorStep] = [
        RenameObservationsProcessorStep(rename_map={}),  # To mimic the same processor as pretrained one
        AddBatchDimensionProcessorStep(),
        MoTPI0NewLineProcessor(),  # Add newlines before tokenization for PaliGemma
        TokenizerProcessorStep(
