...
"""
Processor module for MoT-Pi0 Policy.

This module provides the pre-processing and post-processing pipelines for
the MoT-Pi0 policy. It follows the same pattern as the original Pi0 processor
